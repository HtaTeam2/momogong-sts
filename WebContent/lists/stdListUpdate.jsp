                        ...
                        <div class="fields">
                            <div class="field">
                                ...
                                <table border="1" cellspacing="1" width="100%">
									 <tr>
                                        <td>방번호</td>
                                        <td><input type="text" name="roomNo" value="${lists.roomNo}" readonly/></td>
                                    </tr>
                                    <tr>
                                        <td>등급</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>방이름</td>
                                        <td><input style="width:300px;" type="text" name="roomTitle" value="${lists.roomTitle}"/></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>비밀번호 수정</td>
                                        <td><input type="password" name="roomPw" value="${lists.roomPw}"></td>
                                    </tr>
