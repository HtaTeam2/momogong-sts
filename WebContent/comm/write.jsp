<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="model.domain.CommunityDTO, model.domain.StudyMembersDTO"%>
					...
					<table class="table table-striped">
						...
						<tr>
							...
							<td><textarea rows="10" cols="50" id="content"
									name="comContent" class="form-control"></textarea> <script
						...
						<tr>
							...
							<td colspan="2" class="text-center"><input type="submit"
								value="글쓰기" class="btn btn-success"> <!-- <input type="reset" value="다시작성" class="btn btn-warning"> -->
								<button type="button"
