...
<body>
	...
	<div id="searchList" class="w3-row-padding">
		...
		<center>
			<h3>개인 정보 수정하기</h3>
			<br>
			<form action="${pageContext.request.contextPath}/StdMembers/update"
				method="post">
				<!-- update Form  -->
				<table border="1" cellspacing="1" width="60%">
					...
					<tr>
						...
						<td width="70%"><input class="updateInfo" type="password"
							name="password" value="${allData.password}"></td>
					</tr>

					<tr>

						<td width="30%">이메일 수정</td>
						<td width="70%"><input class="updateInfo" type="text"
							name="email" value="${allData.email}"></td>
					<tr>
					<tr>

						<td width="30%">닉네임 수정</td>
						<td width="70%"><input class="updateInfo" type="text"
							name="nickname" value="${allData.nickname}"></td>
					<tr>
					<tr>

						<td width="30%">목표 수정</td>
						<td width="70%"><input class="updateInfo" type="text"
							name="goal" value="${allData.goal}"></td>
					<tr>
				</table>
				<p />
		...
		--%>
				...
				<input class="btnBox" type="submit" value="수정"> &nbsp; <input
					class="btnBox" type="reset" value="취소">&nbsp;
			</form>
	</div>
	<!-- axios 사용을 위한 추가 설정 -->
