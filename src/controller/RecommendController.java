...
public class RecommendController {
	...
	public String thup(Model model, @RequestParam Map<String, String> params) throws Exception{//@RequestBody long commid, @RequestParam String memid
		System.out.println("thup()----------"+params.get("commid"));
...
//		}
	...
	public String thdown(Model model, @ModelAttribute long commid, @ModelAttribute String memid) throws Exception{
		System.out.println("thup()----------"+commid+memid);
		if(commid == 0 || memid == null || memid.trim().length() == 0) {
			throw new RuntimeException("잘못된 접근입니다. 새로고침 해주세요");
		}
